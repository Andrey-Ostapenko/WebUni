...
namespace livemenu.Areas.Vacancies.Controllers
{
    public partial class VacanciesController
    {
        ...
        protected VacanciesController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public VacanciesController Actions { get { return MVC.Vacancies.Vacancies; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Vacancies";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Vacancies";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Vacancies";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_VacanciesController : livemenu.Areas.Vacancies.Controllers.VacanciesController
    {
        public T4MVC_VacanciesController() : base(Dummy.Instance) { }
