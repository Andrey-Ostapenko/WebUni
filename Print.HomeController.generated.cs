...
namespace livemenu.Areas.Print.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.Print.Home; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Print";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Print/Views/Home/Index.cshtml";
            public readonly string Menu = "~/Areas/Print/Views/Home/Menu.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : livemenu.Areas.Print.Controllers.HomeController
    {
