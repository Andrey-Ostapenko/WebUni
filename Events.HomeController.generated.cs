...
namespace livemenu.Areas.Events.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.Events.Home; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Events";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Events/Views/Home/Index.cshtml";
            public readonly string Menu = "~/Areas/Events/Views/Home/Menu.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : livemenu.Areas.Events.Controllers.HomeController
    {
