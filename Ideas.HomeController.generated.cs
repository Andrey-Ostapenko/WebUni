...
namespace livemenu.Areas.Ideas.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.Ideas.Home; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Ideas";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Ideas/Views/Home/Index.cshtml";
            public readonly string Menu = "~/Areas/Ideas/Views/Home/Menu.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : livemenu.Areas.Ideas.Controllers.HomeController
    {
