...
namespace livemenu.Areas.Plans.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.Plans.Home; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Plans";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Plans/Views/Home/Index.cshtml";
            public readonly string Menu = "~/Areas/Plans/Views/Home/Menu.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : livemenu.Areas.Plans.Controllers.HomeController
    {
