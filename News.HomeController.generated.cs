...
namespace livemenu.Areas.News.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.News.Home; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "News";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/News/Views/Home/Index.cshtml";
            public readonly string Menu = "~/Areas/News/Views/Home/Menu.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : livemenu.Areas.News.Controllers.HomeController
    {
