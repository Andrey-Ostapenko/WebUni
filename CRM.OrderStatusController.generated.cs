...
namespace livemenu.Areas.CRM.Controllers
{
    public partial class OrderStatusController
    {
        ...
        protected OrderStatusController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public OrderStatusController Actions { get { return MVC.CRM.OrderStatus; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "CRM";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "OrderStatus";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "OrderStatus";
        ...
        public class ViewsClass
        {
            ...
            public readonly string GridViewPartial = "~/Areas/CRM/Views/OrderStatus/GridViewPartial.cshtml";
            public readonly string Index = "~/Areas/CRM/Views/OrderStatus/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_OrderStatusController : livemenu.Areas.CRM.Controllers.OrderStatusController
    {
        public T4MVC_OrderStatusController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void GridViewBatchUpdatePartialOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MVCxGridViewBatchUpdateValues<OrderStatus, int> updateValues);

        [NonAction]
        public override System.Web.Mvc.ActionResult GridViewBatchUpdatePartial(MVCxGridViewBatchUpdateValues<OrderStatus, int> updateValues)
        {
