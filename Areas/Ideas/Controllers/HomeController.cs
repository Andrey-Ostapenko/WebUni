...
using livemenu.Areas.Ideas.Controllers;
using livemenu.Kernel.Catalog;

namespace livemenu.Areas.Ideas.Controllers
{
    public partial class HomeController : IdeasController
    {
        ...
        {
            return View(MVC.Ideas.Home.Views.Menu);
        }

        public virtual ActionResult Catalog()
        {
            var catalogItem = _catalogItemService.Get("WebUni-ideas");
