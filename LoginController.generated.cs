...
namespace livemenu.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_LoginController : livemenu.Controllers.LoginController
    {
        public T4MVC_LoginController() : base(Dummy.Instance) { }

        [NonAction]
        partial void LastOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Last()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Last);
            LastOverride(callInfo);
            return callInfo;
        }
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, livemenu.Models.Login.LoginViewModel viewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Login(livemenu.Models.Login.LoginViewModel viewModel)
        {
