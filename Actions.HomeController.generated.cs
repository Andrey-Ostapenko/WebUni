...
namespace livemenu.Areas.Actions.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.Actions.Home; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Actions/Views/Home/Index.cshtml";
            public readonly string Menu = "~/Areas/Actions/Views/Home/Menu.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : livemenu.Areas.Actions.Controllers.HomeController
    {
