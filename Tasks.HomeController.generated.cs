...
namespace livemenu.Areas.Tasks.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.Tasks.Home; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Tasks";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Tasks/Views/Home/Index.cshtml";
            public readonly string Menu = "~/Areas/Tasks/Views/Home/Menu.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : livemenu.Areas.Tasks.Controllers.HomeController
    {
