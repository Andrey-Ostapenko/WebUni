...
{
    public partial class ShortLinkController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ShortLinkController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ShortLinkController Actions { get { return MVC.CMS.ShortLink; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "CMS";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ShortLink";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ShortLink";
        ...
        public class ViewsClass
        {
            ...
            public readonly string GridViewPartial = "~/Areas/CMS/Views/ShortLink/GridViewPartial.cshtml";
            public readonly string Index = "~/Areas/CMS/Views/ShortLink/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ShortLinkController : livemenu.Areas.CMS.Controllers.ShortLinkController
    {
        public T4MVC_ShortLinkController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void GridViewBatchUpdatePartialOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MVCxGridViewBatchUpdateValues<ShortLink, int> updateValues);

        [NonAction]
        public override System.Web.Mvc.ActionResult GridViewBatchUpdatePartial(MVCxGridViewBatchUpdateValues<ShortLink, int> updateValues)
        {
