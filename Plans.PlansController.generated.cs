...
namespace livemenu.Areas.Plans.Controllers
{
    public partial class PlansController
    {
        ...
        protected PlansController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PlansController Actions { get { return MVC.Plans.Plans; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Plans";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Plans";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Plans";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PlansController : livemenu.Areas.Plans.Controllers.PlansController
    {
        public T4MVC_PlansController() : base(Dummy.Instance) { }
