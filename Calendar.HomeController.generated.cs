...
namespace livemenu.Areas.Calendar.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.Calendar.Home; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Calendar";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Calendar/Views/Home/Index.cshtml";
            public readonly string Menu = "~/Areas/Calendar/Views/Home/Menu.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : livemenu.Areas.Calendar.Controllers.HomeController
    {
