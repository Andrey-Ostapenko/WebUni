...
namespace livemenu.Areas.Docs.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.Docs.Home; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Docs";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Docs/Views/Home/Index.cshtml";
            public readonly string Menu = "~/Areas/Docs/Views/Home/Menu.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : livemenu.Areas.Docs.Controllers.HomeController
    {
