...
namespace livemenu.Areas.CMS.Controllers
{
    public partial class SearchController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SearchController Actions { get { return MVC.CMS.Search; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string GridViewPartial = "~/Areas/CMS/Views/Search/GridViewPartial.cshtml";
            public readonly string Index = "~/Areas/CMS/Views/Search/Index.cshtml";
            public readonly string SelectorGridViewPartial = "~/Areas/CMS/Views/Search/SelectorGridViewPartial.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SearchController : livemenu.Areas.CMS.Controllers.SearchController
    {
        ...
        [NonAction]
        partial void GridViewBatchUpdatePartialOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MVCxGridViewBatchUpdateValues<SearchProperty, int> updateValues);

        [NonAction]
        public override System.Web.Mvc.ActionResult GridViewBatchUpdatePartial(MVCxGridViewBatchUpdateValues<SearchProperty, int> updateValues)
        {
