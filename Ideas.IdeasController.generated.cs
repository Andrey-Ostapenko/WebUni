...
namespace livemenu.Areas.Ideas.Controllers
{
    public partial class IdeasController
    {
        ...
        protected IdeasController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public IdeasController Actions { get { return MVC.Ideas.Ideas; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Ideas";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Ideas";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Ideas";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_IdeasController : livemenu.Areas.Ideas.Controllers.IdeasController
    {
        public T4MVC_IdeasController() : base(Dummy.Instance) { }
