...
namespace livemenu.Areas.Research.Controllers
{
    public partial class ResearchController
    {
        ...
        protected ResearchController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ResearchController Actions { get { return MVC.Research.Research; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Research";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Research";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Research";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ResearchController : livemenu.Areas.Research.Controllers.ResearchController
    {
        public T4MVC_ResearchController() : base(Dummy.Instance) { }
