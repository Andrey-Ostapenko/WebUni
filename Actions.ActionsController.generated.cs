...
namespace livemenu.Areas.Actions.Controllers
{
    public partial class ActionsController
    {
        ...
        protected ActionsController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionsController Actions { get { return MVC.Actions.Actions; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Actions";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Actions";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Actions";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ActionsController : livemenu.Areas.Actions.Controllers.ActionsController
    {
        public T4MVC_ActionsController() : base(Dummy.Instance) { }
