...
namespace livemenu.Areas.Ads.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.Ads.Home; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Ads";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Ads/Views/Home/Index.cshtml";
            public readonly string Menu = "~/Areas/Ads/Views/Home/Menu.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : livemenu.Areas.Ads.Controllers.HomeController
    {
